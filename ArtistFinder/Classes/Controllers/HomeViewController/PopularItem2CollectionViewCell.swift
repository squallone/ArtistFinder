//
//  PopularItem2CollectionViewCell.swift
//  ArtistFinder
//
...
class PopularItem2CollectionViewCell: UICollectionViewCell {
    ...
    private func setupComponents()  {
        // Setup songsLabel
        let songsLabelAttrString = NSMutableAttributedString(string: "296 Songs", attributes: [
